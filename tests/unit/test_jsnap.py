...
class TestJsnapy(unittest.TestCase):
    ...
    @patch('jnpr.jsnapy.jsnapy.Parse')
    ...
    @patch('jnpr.jsnapy.jsnapy.Jsnapy.login')
    ...
    @patch('jnpr.jsnapy.jsnapy.Jsnapy.connect')
    ...
    @patch('jnpr.jsnapy.jsnapy.Jsnapy.generate_rpc_reply')
    ...
    @patch('jnpr.jsnapy.jsnapy.Jsnapy.compare_tests')
    ...
    @patch('jnpr.jsnapy.jsnapy.Notification.notify')
...
with nested(
    ...
    if __name__ == "__main__":
        suite = unittest.TestLoader().loadTestsFromTestCase(TestJsnapy)
