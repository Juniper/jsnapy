...
chk = js.check("/etc/jsnapy/config_single_check.yml", "/etc/jsnapy/10.209.16.204_pre_show_interfaces_terse_lo*.xml", "/etc/jsnapy/10.209.16.204_post_show_interfaces_terse_lo*.xml")
for check in chk:
